...
require_once(dirname(__FILE__)."/pens_request_receipt.php");
require_once(dirname(__FILE__)."/pens_request_collect.php");
require_once(dirname(__FILE__)."/pens_request_alert.php");
